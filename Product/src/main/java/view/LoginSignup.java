...
public final class LoginSignup extends javax.swing.JFrame {
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        if (usernameTextField.getText().equals("Enter your username") || passwordTextField.getPassword().equals("Password")) {
    ...
    /**
     * Handles the action performed when the informationButton is clicked.
     *
     * @param evt The ActionEvent triggered by clicking the button.
     */
    ...
    /**
     * This method is called when the window is closed. It is responsible for handling any necessary
     * actions when the window is closed.
     *
     * @param evt The WindowEvent triggered by closing the window.
     */
