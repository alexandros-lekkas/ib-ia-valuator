...
public class Company {
    ...
    /**
     * Updates the details of the Company object with the provided values.
     *
     * @param newName The new name of the company.
     * @param newDescription The new description of the company.
     * @param newCountry The new country of the company.
     */
    public void updateCompanyDetails(String newName, String newDescription, String newCountry) {
        ...
        // Create an ArrayList to store all the lines.
        ...
        try (BufferedReader bufferedReader = new BufferedReader(new FileReader(filePath))) {
            ...
            while ((line = bufferedReader.readLine()) != null) {
                ...
                // Process each line and update the necessary line with the new values.
                if (line.startsWith("Name")) {
                    ...
                    line = "Country" + newCountry;

                }

                // Add the (possibly updated) line to our list of lines
                lines.add(line);
        ...
        // Now write the updated lines back into the file
