...
public class Merger extends javax.swing.JFrame {
    ...
    /**
     * Executes the action when the informationButton is clicked.
     * It logs the button click, and displays an information message.
     *
     * @param evt The event triggered by the button click.
     */
    private void informationButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_informationButtonActionPerformed
        ...
        JOptionPane.showMessageDialog(
                ...
                this,
                "Select two companies and merge them together.",
                "Information",
                JOptionPane.INFORMATION_MESSAGE
     ...
     *
     * @param evt The window event that triggered the method.
     */
     ...
     */
    private ArrayList<Data> combineData(ArrayList<Data> data1, ArrayList<Data> data2) {
