...
public class Dashboard extends javax.swing.JFrame {
     ...
     *
     * @param authentication The Authentication object used for user authentication. The authentication object should
     *                       contain the user object and the company list.
     */
    ...
    /**
     * Creates a new Dashboard object for the given user. The Dashboard object represents a user interface for the
     * User's dashboard.
     *
     * @param user The User object representing the current user. This object should contain the user's information and
     *             company list.
     */
    public Dashboard(User user) {

        this.user = user;
        this.companies = user.getCompanyList();
     ...
     *
     * @param evt The WindowEvent that triggered this method.
     */
    ...
    private JButton createCompanyButton() {
        ...
        companyButton.addActionListener((ActionEvent event) -> {
            ...
            dispose();
            new view.company.Dashboard(company, user).setVisible(true);
